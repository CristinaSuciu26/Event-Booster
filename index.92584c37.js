const e=async(e=0,t=150)=>{try{let n=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=GzEcjG7UqsA0w1fiokdTexVqAJ8XI1c3&page=${e}&size=${t}`);if(!n.ok)throw Error(`HTTP error! Status: ${n.status}`);let a=await n.json();return console.log(a),a}catch(e){throw console.error("Error fetching events:",e),e}},t=()=>{window.addEventListener("load",()=>{let e=document.getElementById("loader"),t=document.getElementById("content");setTimeout(()=>{e.style.display="none",t.style.display="block"},1e3)})},n=e=>{let t=document.getElementById("modal"),n=document.getElementById("close-modal"),a=document.getElementById("modal-content"),s=document.createElement("div");a.appendChild(s),document.addEventListener("click",e=>{let a=e.target.closest(".event-container");if(a){t.style.display="block";let e=a.dataset.imageUrl,n=a.dataset.title,o=a.dataset.description,i=a.dataset.date,l=a.dataset.time,d=a.dataset.timezone,c=a.dataset.location,r=a.dataset.name,m=a.dataset.maxprice,p=a.dataset.minprice;s.innerHTML="",s.innerHTML=`
    ...
    <div class="image-wrapper" >
      ...
      </div>`,t.appendChild(n)})};let s=1;const o=document.getElementById("pagination-container"),i=e=>{o.innerHTML=`
  ...
  `,document.querySelectorAll(".num-pagination").forEach(e=>{e.addEventListener("click",e=>{let t=parseInt(e.target.textContent,10);isNaN(t)||(s=t,c())})}),document.querySelector("#prev-btn").onclick=()=>{s>1&&(s--,c())},document.querySelector("#next-btn").onclick=()=>{s<e&&(s++,c())}};let l=[],d=[];const c=()=>{let e=d.length?d:l,t=Math.ceil(e.length/10),n=(s-1)*10;a(e.slice(n,n+10)),i(t)},r=e=>{l=e,d=[],s=1,c()},m=e=>{d=e,s=1,c()},p=e=>{let t=document.querySelector(".input-container"),n=document.getElementById("event-container");t.innerHTML=`
      <input type="text" placeholder="Start searching" id="search-input" />
      <div class="search-icon"></div>
    `,document.getElementById("search-input").addEventListener("input",t=>{let s=t.target.value.toLowerCase(),o=e.filter(e=>e.name.toLowerCase().includes(s));if(n.innerHTML="",!o.length){let e=document.createElement("div");e.classList.add("newContainer"),e.textContent="No events found",n.appendChild(e),document.getElementById("pagination-container").innerHTML="";return}a(o),r(o)})},u=e=>{let t=document.getElementById("choices"),n=new Choices(t);e.filter(e=>e.dates.timezone).forEach(e=>{let n=document.createElement("option");n.value=e.dates.timezone,n.textContent=e.dates.timezone,t.appendChild(n)}),t.addEventListener("change",t=>{let n=t.target.value;n?m(e.filter(e=>e.dates.timezone===n)):r(e)}),n.destroy(),n=new Choices(t)};document.addEventListener("DOMContentLoaded",async()=>{try{t();let a=(await e())._embedded.events;console.log("ev",a),p(a),n(a),r(a),u(a)}catch(e){console.error("Error fetching events:",e)}});
//# sourceMappingURL=index.92584c37.js.map
