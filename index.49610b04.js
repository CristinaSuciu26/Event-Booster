const e=async(e=0,t=150)=>{try{let n=await fetch(`https://app.ticketmaster.com/discovery/v2/events.json?apikey=GzEcjG7UqsA0w1fiokdTexVqAJ8XI1c3&page=${e}&size=${t}`);if(!n.ok)throw Error(`HTTP error! Status: ${n.status}`);let a=await n.json();return console.log(a),a}catch(e){throw console.error("Error fetching events:",e),e}},t=()=>{window.addEventListener("load",()=>{let e=document.getElementById("loader"),t=document.getElementById("content");setTimeout(()=>{e.style.display="none",t.style.display="block"},1e3)})},n=e=>{let t=document.getElementById("modal"),n=document.getElementById("close-modal"),a=document.getElementById("modal-content"),s=document.createElement("div");a.appendChild(s),document.addEventListener("click",e=>{let a=e.target.closest(".event-container");if(a){t.style.display="block";let e=a.dataset.imageUrl,n=a.dataset.title,i=a.dataset.description,o=a.dataset.date,c=a.dataset.time,l=a.dataset.timezone,d=a.dataset.location,r=a.dataset.name,m=a.dataset.maxprice,p=a.dataset.minprice;s.innerHTML="",s.innerHTML=`
      ...
      <div class="modal-wrapper">
        ...
        <p class="event-info">${i}</p>

        <h2 class="modal-headings">WHEN</h2>
        <p class="event-info">${o} at ${c} (${l})</p>

        <h2 class="modal-headings">WHERE</h2>
        <p class="event-info">${d} (${l})</p>
...
<button class="more-btn">MORE FROM THIS AUTHOR</button>
  ...
  `,document.querySelectorAll(".num-pagination").forEach(e=>{e.addEventListener("click",e=>{let t=parseInt(e.target.textContent,10);isNaN(t)||(s=t,d())})}),document.querySelector("#prev-btn").onclick=()=>{s>1&&(s--,d())},document.querySelector("#next-btn").onclick=()=>{s<e&&(s++,d())}};let c=[],l=[];const d=()=>{let e=l.length?l:c,t=Math.ceil(e.length/10),n=(s-1)*10;a(e.slice(n,n+10)),o(t)},r=e=>{c=e,l=[],s=1,d()},m=e=>{l=e,s=1,d()},p=e=>{let t=document.querySelector(".input-container"),n=document.getElementById("event-container");t.innerHTML=`
      <input type="text" placeholder="Start searching" id="search-input" />
      <div class="search-icon"></div>
    `,document.getElementById("search-input").addEventListener("input",t=>{let s=t.target.value.toLowerCase(),i=e.filter(e=>e.name.toLowerCase().includes(s));if(n.innerHTML="",!i.length){let e=document.createElement("div");e.classList.add("newContainer"),e.textContent="No events found",n.appendChild(e),document.getElementById("pagination-container").innerHTML="";return}a(i),r(i)})},u=e=>{let t=document.getElementById("choices"),n=new Choices(t);e.filter(e=>e.dates.timezone).forEach(e=>{let n=document.createElement("option");n.value=e.dates.timezone,n.textContent=e.dates.timezone,t.appendChild(n)}),t.addEventListener("change",t=>{let n=t.target.value;n?m(e.filter(e=>e.dates.timezone===n)):r(e)}),n.destroy(),n=new Choices(t)};document.addEventListener("DOMContentLoaded",async()=>{try{t();let a=(await e())._embedded.events;console.log("ev",a),p(a),n(a),r(a),u(a)}catch(e){console.error("Error fetching events:",e)}});
//# sourceMappingURL=index.49610b04.js.map
